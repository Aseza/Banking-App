...
<body>
	...
	<div class="mn-content fixed-sidebar ">
		<div class="navbar-fixed">
			<nav class="nav-extended blue-grey">
				<div class="nav-wrapper">
					<a href="#" class="center brand-logo"><img width="60em" src="<c:url value="/resources/css/logo.png" />" /></a> <a href="#"
				...
				<div class="nav-content">
					<ul class="tabs tabs-transparent tabs-fixed-width">
						<li class="tab"><a href="#check">Verifier</a></li>
						<li class="tab"><a class="active" href="#checkResult">Info</a></li>
		...
		<div id="check" class="col s12">
			<h5 class="center-align">Entrez Vos Details</h5>
			<form action="checkInfoMain" method="post"
				class="checkForm hoverable">
				<div class="group">
					<input placeholder="Transaction" type='text' id='transactionID'
						name='transactionID' value='C8732971' required><span
		...
		<div id="checkResult" class="col s12 ">
			<c:choose>
				<c:when test="${requestScope.status eq 'SUCCESS'}">
					<h4 class="center-align">Status is: ${requestScope.status}</h4>
					<c:if test="${requestScope.status ne 'Success'}">
						<c:forEach items="${requestScope.msg}" var="item">
						...
						<table class="striped centered">
							...
							<tbody>
								<tr>
									...
									<td>${requestScope.gShortNames}</td>
									<td>${requestScope.gCountries}</td>
				...
				<c:when test="${requestScope.status eq 'T_24_ERROR'}">
					<c:forEach items="${requestScope.msg}" var="item">
						<h5 class="center-align">
							<c:out value="Error: ${item}" />
						</h5>
				...
				<c:otherwise>
					<h5 class="center-align" style="margin-top: 20%">
						ERROR :
						<c:redirect url="error500" />
					</h5>
				</c:otherwise>
			</c:choose>
		</div>
